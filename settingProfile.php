...
* {  margin:0; padding:0;}
    body{
		 background-color:#cbe34d;
		
	}
   .body{
      background-image:url(pic/settingProfile.jpg);
  ...
  <nav>
		 ...
		 <ul>
	       ...
	       <div class ="data">
	          ...
	          <a href="changePassword.php" >Change Password</a><br><br><br>
	                   ...
	                   <div class="main">
	                         <h1 id="about">About</h1>
	                            <table  >
                                        ...
                                        <tr>
                                        <td><label><?php echo $fname;?></label><hr id="h"></td>
                                        <td><label><?php echo $lname;?></label><hr></td>
                                        <td><label><?php echo $gender;?></label><hr></td>
                                        </tr>
                                ...
                                <table >
                                        ...
                                        <tr>
                                        <td><label><?php echo $pno;?></label><hr></td>
                                        <td><label><?php echo $email;?></label><hr></td>
                                        <td><label><?php echo $dob;?></label><hr></td>
                                        </tr>
